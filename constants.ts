...
export const FACE_ASSETS_URL = "/faces/"; // "https://my-app-faces-assets.s3.us-east-1.amazonaws.com/";
...
export const FRIEND_USER: User = {
  ...
  coverUrl:
    "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1200&q=80", // Foggy Nature
...
export const OFFICIAL_USER: User = {
  ...
  coverUrl:
    "https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?auto=format&fit=crop&w=1200&q=80", // Space
...
export const NON_FRIEND_USER: User = {
  ...
  coverUrl:
    "https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?auto=format&fit=crop&w=1200&q=80", // Abstract Weather
  location: "Chicago, IL",
  joinDate: "2023",
  isVerified: false,
  isFriend: false,
...
export const PINNED_MEMORIES: Memory[] = [
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=600&q=80", // Dog
    selfieUrl:
      "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=200&q=80",
    realMojiCount: 12,
  },
  {
    ...
    date: "April 13 2022",
    imageUrl:
      "https://images.unsplash.com/photo-1543373014-cfe4f4bc1cdf?auto=format&fit=crop&w=600&q=80", // Tennis
    selfieUrl:
      "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=200&q=80",
    realMojiCount: 8,
  },
  {
    ...
    date: "June 25 2023",
    imageUrl:
      "https://images.unsplash.com/photo-1509557965875-b88c97052f0e?auto=format&fit=crop&w=600&q=80", // Nature
    selfieUrl:
      "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=200&q=80",
    realMojiCount: 5,
  },
  {
    ...
    date: "July 04 2023",
    imageUrl:
      "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=200&q=80", // Fireworks
    selfieUrl:
      "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=200&q=80",
    realMojiCount: 15,
  },
  {
    ...
    date: "August 19 2023",
    imageUrl:
      "https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=600&q=80", // Cinque Terre / Travel
    selfieUrl:
      "https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?auto=format&fit=crop&w=200&q=80",
    realMojiCount: 42,
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1509557965875-b88c97052f0e?auto=format&fit=crop&w=600&q=80", // Pumpkin / Halloween
    selfieUrl:
      "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&q=80",
    realMojiCount: 9,
  },
